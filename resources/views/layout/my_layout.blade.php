...
<head>
    ...
    <!-- Chartist -->
    <link rel="stylesheet" href="../../js/plugins/chartist/css/chartist.min.css">
    <link rel="stylesheet" href="../../js/plugins/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css">
    <!-- Custom Stylesheet -->
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="{{ url('/arquivos') }}">
                    <b class="logo-abbr">
                        {{-- Gato só pra sair logo do template padão, tem que fazer logo png SIGED --}}
                        <p style="font-size: 150%; color: aliceblue">SD</p>  
                    ...
                    <span class="brand-title">
                        ...
                        {{-- Gato só pra sair logo do template padão, tem que fazer logo png SIGED --}}
                        <p style="font-size: 150%; color: aliceblue"> SIGED </p>
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            {{-- <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Cadastro</span> --}}
                            <i class="icon-note menu-icon"></i><span class="nav-text">Cadastro</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ url('/arquivos/add')}}">Novo</a></li>
                            {{-- <li><a href="{{ url('/arquivos/adit')}}">Editar</a></li>
